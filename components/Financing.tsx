        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact"
                className="bg-[#FFC107] hover:bg-yellow-400 text-black font-bold px-8 py-4 rounded text-sm text-center transition-colors uppercase tracking-wide">
                Apply Now — It&apos;s Free
              </a>
              <a href="#contact"
                className="border border-white/30 hover:border-[#FFC107] hover:text-[#FFC107] text-white font-semibold px-8 py-4 rounded text-sm text-center transition-colors">
                Learn More
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {items.map((item) => (
              <div key={item.title} className="bg-[#222] rounded-xl p-6 border border-white/10 hover:border-[#FFC107]/50 transition-colors">
