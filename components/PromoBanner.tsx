  ...
  return (
    <div className="bg-[#1E3A8A] py-3">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-center gap-4">
        ...
        <a href="#financing"
          className="bg-white text-[#1E3A8A] text-xs font-bold uppercase tracking-wider px-5 py-2 rounded hover:bg-blue-50 transition-colors whitespace-nowrap">
          Learn More
        </a>
      </div>
    </div>
