    ...
    <section id="contact" className="bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-center">
          <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 hover:border-[#1E3A8A] transition-colors">
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 hover:border-[#1E3A8A] transition-colors">
            ...
            <a href="tel:+17325550192" className="text-2xl font-black text-black hover:text-[#1d4ed8] transition-colors">
              (732) 555-0192
            </a>
        ...
        <div className="mt-12 bg-[#0f172a] rounded-2xl p-10 text-center text-white">
