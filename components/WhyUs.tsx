    ...
    <section id="why-us" className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((reason) => (
            <div key={reason.title} className="p-6 rounded-xl border border-gray-100 hover:border-[#FFC107] hover:shadow-md transition-all">
              <div className="w-8 h-1 bg-[#FFC107] rounded mb-4" />
